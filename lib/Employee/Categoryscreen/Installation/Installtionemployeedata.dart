              ...
              onPressed: () async {
                if (_formKey.currentState!.validate()) {
                  try {
                    ...
                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>AssignedTaskForInstallation()));
          ...
          children: [
            AppBar(
              title: const Text(
                ...
                style:
                TextStyle(color: Colors.white, fontWeight: FontWeight.bold,fontSize: 14,fontFamily: "Times New Roman"),
              ),
              centerTitle: true,
              backgroundColor: Colors.blue.shade900,
