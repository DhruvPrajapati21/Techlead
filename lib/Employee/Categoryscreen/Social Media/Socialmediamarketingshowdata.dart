...
class Socialmediamarketingshowdata extends StatefulWidget {
  const Socialmediamarketingshowdata({super.key});

  @override
  State<Socialmediamarketingshowdata> createState() => _SocialmediamarketingshowdataState();
}

class _SocialmediamarketingshowdataState extends State<Socialmediamarketingshowdata> {
  String searchQuery = "";
  DateTime? startDate;
  DateTime? endDate;
