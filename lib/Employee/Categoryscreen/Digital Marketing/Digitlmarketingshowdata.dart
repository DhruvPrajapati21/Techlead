...
class _DigitlmarketingshowdataState extends State<Digitlmarketingshowdata> {
              ...
              onPressed: () async {
                if (_formKey.currentState!.validate()) {
                  try {
                    ...
                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Digitlmarketingshowdata()));
  ...
  Widget _buildTaskCard(Map<String, dynamic> task, bool highlight, String docId) {
    return Padding(
