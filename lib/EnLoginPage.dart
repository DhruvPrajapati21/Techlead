        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: TextFormField(
              ...
              validator: validator,
              style: const TextStyle(color: Colors.white,fontWeight: FontWeight.bold), // Set text color to white
              decoration: InputDecoration(
                hintText: hintText, // Added hint text here
                hintStyle: TextStyle(color: hintTextColor), // Set the color of the hint text
                filled: true,
                fillColor: Colors.transparent, // Make sure the background is transparent for the gradient
